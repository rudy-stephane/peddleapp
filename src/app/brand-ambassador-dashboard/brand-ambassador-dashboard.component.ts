...
*/
  ...
  socialchange(){
    ...
    if(this.social_input.value == 'FaceBook'){
      this.select_flux = new FormControl('Activity');
      ...
      this.select_flux = new FormControl('Flux');
      ...
      this.select_flux = new FormControl('Acceuil');
      ...
      this.select_flux = new FormControl('Posts');
    }
